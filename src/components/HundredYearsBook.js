...
const HundredYearsBook = () => {
  ...
  >
      <button className='item-button' onClick={handleShow}><img id='hundred-years' src={HundredYears} alt='The Hundred Years War on Palestine, by Rashid Khalidi' width="180px"></img></button>
      </OverlayTrigger>
      ...
      <h6>2020</h6>
        ...
        <Offcanvas.Body>
        <a href="https://www.goodreads.com/book/show/41812831-the-hundred-years-war-on-palestine" target="_blank" rel="noopener noreferrer"><img id='hb-album' src={HundredYears} alt='The Hundred Years War on Palestine, by Rashid Khalidi' width="200px"></img></a><br></br>
